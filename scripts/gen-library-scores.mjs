...
function noteXml(n) {
  if (n.rest) {
    const out = ['      <note>', '        <rest/>', `        <duration>${n.dur}</duration>`, '        <voice>1</voice>', `        <type>${n.type}</type>`];
...
function buildScore(p) {
  ...
  L.push('      <score-instrument id="P1-I1"><instrument-name>Piano</instrument-name></score-instrument>');
  L.push('      <midi-instrument id="P1-I1"><midi-channel>1</midi-channel><midi-program>1</midi-program></midi-instrument>');
  L.push('    </score-part>');
  L.push('  </part-list>');
  L.push('  <part id="P1">');
  ...
  measures.forEach((bar, i) => {
    ...
    if (i === 0) {
      ...
      if (p.tempo) {
        ...
        L.push(`        <metronome><beat-unit>quarter</beat-unit><per-minute>${p.tempo}</per-minute></metronome>`);
...
const PIECES = [
  ...
  { id: 'twinkle', title: 'Twinkle, Twinkle, Little Star', titleJp: 'きらきら星', composer: 'Wolfgang Amadeus Mozart', composerJp: 'モーツァルト', died: 1791, level: 1, time: [4, 4], tempo: 96,
    notes: ['C4','C4','G4','G4','A4','A4','G4:h','F4','F4','E4','E4','D4','D4','C4:h','G4','G4','F4','F4','E4','E4','D4:h','G4','G4','F4','F4','E4','E4','D4:h','C4','C4','G4','G4','A4','A4','G4:h','F4','F4','E4','E4','D4','D4','C4:h'] },
  { id: 'mary_lamb', title: 'Mary Had a Little Lamb', titleJp: 'メリーさんのひつじ', composer: 'Traditional', composerJp: '伝承曲', died: 0, level: 1, time: [4, 4], tempo: 100,
    notes: ['E4','D4','C4','D4','E4','E4','E4:h','D4','D4','D4:h','E4','G4','G4:h','E4','D4','C4','D4','E4','E4','E4','E4','D4','D4','E4','D4','C4:w'] },
  { id: 'frere_jacques', title: 'Frère Jacques', titleJp: 'フレール・ジャック', composer: 'Traditional', composerJp: '伝承曲', died: 0, level: 1, time: [4, 4], tempo: 108,
    notes: ['C4','D4','E4','C4','C4','D4','E4','C4','E4','F4','G4:h','E4','F4','G4:h','G4:e','A4:e','G4:e','F4:e','E4','C4','G4:e','A4:e','G4:e','F4:e','E4','C4','C4','G3','C4:h','C4','G3','C4:h'] },
  { id: 'old_macdonald', title: 'Old MacDonald Had a Farm', titleJp: 'ゆかいな牧場', composer: 'Traditional', composerJp: '伝承曲', died: 0, level: 1, time: [4, 4], tempo: 112,
    notes: ['G4','G4','G4','D4','E4','E4','D4:h','B4','B4','A4','A4','G4:w','G4','G4','G4','D4','E4','E4','D4:h','B4','B4','A4','A4','G4:w'] },
  { id: 'london_bridge', title: 'London Bridge', titleJp: 'ロンドン橋', composer: 'Traditional', composerJp: '伝承曲', died: 0, level: 1, time: [4, 4], tempo: 108,
    notes: ['G4','A4','G4','F4','E4','F4','G4:h','D4','E4','F4:h','E4','F4','G4:h','G4','A4','G4','F4','E4','F4','G4:h','D4:h','G4:h','E4:h','C4:h'] },
  { id: 'hot_cross_buns', title: 'Hot Cross Buns', titleJp: 'ホット・クロス・バンズ', composer: 'Traditional', composerJp: '伝承曲', died: 0, level: 1, time: [4, 4], tempo: 100,
    notes: ['E4','D4','C4:h','E4','D4','C4:h','C4:e','C4:e','C4:e','C4:e','D4:e','D4:e','D4:e','D4:e','E4','D4','C4:h'] },
  { id: 'jingle_bells', title: 'Jingle Bells (Chorus)', titleJp: 'ジングルベル', composer: 'James Lord Pierpont', composerJp: 'ピアポント', died: 1893, level: 1, time: [4, 4], tempo: 120,
    notes: ['E4','E4','E4:h','E4','E4','E4:h','E4','G4','C4:q.','D4:e','E4:w','F4','F4','F4:q.','F4:e','F4','E4','E4','E4:e','E4:e','E4','D4','D4','E4','D4:h','G4:h'] },
  { id: 'au_clair_de_la_lune', title: 'Au Clair de la Lune', titleJp: '月の光に', composer: 'Traditional', composerJp: '伝承曲', died: 0, level: 1, time: [4, 4], tempo: 96,
    notes: ['C4','C4','C4','D4','E4:h','D4:h','C4','E4','D4','D4','C4:w'] },
  { id: 'beethoven_fifth', title: 'Symphony No. 5 (opening)', titleJp: '交響曲第5番「運命」冒頭', composer: 'Ludwig van Beethoven', composerJp: 'ベートーヴェン', died: 1827, level: 1, time: [4, 4], tempo: 108,
    notes: ['r:e','G4:e','G4:e','G4:e','Eb4:h','r:e','F4:e','F4:e','F4:e','D4:h'] },
  { id: 'ode_to_joy', title: 'Ode to Joy', titleJp: '歓喜の歌', composer: 'Ludwig van Beethoven', composerJp: 'ベートーヴェン', died: 1827, level: 2, time: [4, 4], tempo: 100,
    notes: ['E4','E4','F4','G4','G4','F4','E4','D4','C4','C4','D4','E4','E4:q.','D4:e','D4:h','E4','E4','F4','G4','G4','F4','E4','D4','C4','C4','D4','E4','D4:q.','C4:e','C4:h'] },

  // ---- Level 2 — easy classical themes ----
  { id: 'canon_in_d', title: 'Canon in D (theme)', titleJp: 'カノン（主題）', composer: 'Johann Pachelbel', composerJp: 'パッヘルベル', died: 1706, level: 2, time: [4, 4], tempo: 92,
    notes: ['E5:h','D5:h','C5:h','B4:h','A4:h','G4:h','A4:h','B4:h','E5','D5','C5','B4','A4','G4','A4','B4','C5','B4','A4','G4','F4','E4','F4','G4'] },
  { id: 'minuet_in_g', title: 'Minuet in G (BWV Anh. 114)', titleJp: 'メヌエット ト長調', composer: 'Christian Petzold', composerJp: 'ペツォールト', died: 1760, level: 2, time: [3, 4], tempo: 120,
    notes: ['D5','G4:e','A4:e','B4:e','C5:e','D5','G4','G4','E5','C5:e','D5:e','E5:e','F#5:e','G5','G4','G4','C5','D5','C5','B4','A4','B4','C5','B4','A4','G4','F#4','G4','A4','B4','G4','B4:h.'] },
  { id: 'grieg_mountain_king', title: 'In the Hall of the Mountain King', titleJp: '山の魔王の宮殿にて', composer: 'Edvard Grieg', composerJp: 'グリーグ', died: 1907, level: 2, time: [4, 4], tempo: 108,
    notes: ['A4:e','B4:e','C5:e','D5:e','E5:e','C5:e','E5:e','C5:e','A4:e','B4:e','C5:e','D5:e','E5:e','C5:e','E5:e','C5:e','C5:e','D5:e','E5:e','F5:e','G5:e','E5:e','G5:e','E5:e','C5:e','D5:e','E5:e','F5:e','G5:e','E5:e','G5:e','E5:e'] },
  { id: 'new_world_largo', title: 'New World Symphony (Largo)', titleJp: '新世界より「家路」', composer: 'Antonín Dvořák', composerJp: 'ドヴォルザーク', died: 1904, level: 2, time: [4, 4], tempo: 72,
    notes: ['E4','G4','G4:h','G4','E4','D4:h','E4','G4','E4','D4','C4:w','E4','G4','G4:h','G4','E4','D4:h','E4','D4','C4:h'] },

  // ---- Level 3 — intermediate ----
  { id: 'gymnopedie_1', title: 'Gymnopédie No. 1 (theme)', titleJp: 'ジムノペディ 第1番', composer: 'Erik Satie', composerJp: 'サティ', died: 1925, level: 3, time: [3, 4], tempo: 66,
    notes: ['F#5:h.','A5:h.','G#5:h.','B5:h.','C#6:h','B5:q','A5:h','G#5:q','F#5:h','E5:q','D5:h.','C#5:h.'] },
  { id: 'bizet_habanera', title: 'Habanera (Carmen)', titleJp: 'ハバネラ（カルメン）', composer: 'Georges Bizet', composerJp: 'ビゼー', died: 1875, level: 3, time: [2, 4], tempo: 100,
    notes: ['D5:q.','C#5:e','C5:e','B4:e','Bb4:e','A4:e','A4:q.','A4:e','Bb4:e','B4:e','Bb4:e','A4:e','Ab4:q.','G4:e','Gb4:e','G4:e','Gb4:e','F4:e','E4:q','E4:q'] },
  { id: 'bach_prelude_c', title: 'Prelude in C (BWV 846)', titleJp: '前奏曲 ハ長調 BWV 846', composer: 'Johann Sebastian Bach', composerJp: 'バッハ', died: 1750, level: 3, time: [4, 4], tempo: 72,
    notes: ['C4:e','E4:e','G4:e','C5:e','E5:e','G4:e','C5:e','E5:e','C4:e','D4:e','A4:e','D5:e','F5:e','A4:e','D5:e','F5:e','B3:e','D4:e','G4:e','D5:e','F5:e','G4:e','D5:e','F5:e','C4:e','E4:e','G4:e','C5:e','E5:e','G4:e','C5:e','E5:e'] },
  { id: 'bach_toccata_dm', title: 'Toccata in D minor (opening)', titleJp: 'トッカータ ニ短調（冒頭）', composer: 'Johann Sebastian Bach', composerJp: 'バッハ', died: 1750, level: 3, time: [4, 4], tempo: 76,
    notes: ['A5:e','G5:e','A5:h','r:q','G5:e','F5:e','E5:e','D5:e','C#5:e','D5:e','C#5:e','D5:e','A4:h','r:h'] },

  // ---- Level 4 — advanced (themes / melodic lines) ----
  { id: 'chopin_nocturne_op9no2', title: 'Nocturne Op. 9 No. 2 (melody)', titleJp: 'ノクターン Op.9-2（旋律）', composer: 'Frédéric Chopin', composerJp: 'ショパン', died: 1849, level: 4, time: [3, 4], tempo: 66,
